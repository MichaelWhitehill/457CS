...
enum ops{HELP,JSON,MSG,AWAY,INFO,INVITE,JOIN,KICK,KILL,KNOCK,NICK,NOTICE,PART,OPER,PASS,PRIVMSG,QUIT,SETNAME,TOPIC,USER,USERHOST,USERIP,USERS,WALLOPS,WHO,WHOIS,PING,TIME,RULES,VERSION, LOCK, UNLOCK,LIST, ISON, SILENCE};
